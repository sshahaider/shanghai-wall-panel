import { SITE_DOMAIN, SITE_NAME, SITE_URL } from '@/lib/constentsts';
import Link from 'next/link';

const meta = {
	title: `Privacy Policy - ${SITE_NAME}`,
	dec: `At ${SITE_NAME}, we take your privacy seriously.`,
	link: `/policy`,
};
...
export function generateMetadata() {
	return {
		...
		keywords: [`Privacy Policy`, SITE_NAME],
		alternates: {
			canonical: meta.link,
		},
	};
...
export default function Policy() {
	return (
		<div className="prose lg:prose-xl mx-auto py-24">
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;Our&quot; in this Agreement) refers to {SITE_DOMAIN}.
					</p>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						<strong>Website</strong> refers to {SITE_DOMAIN}, accessible from <Link href="/">{SITE_URL}/</Link>
					</p>
				</li>
				<li>
					<p>
